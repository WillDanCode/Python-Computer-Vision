...
person_cascade = cv2.CascadeClassifier(os.path.join('../venv/Lib/site-packages/cv2/data/haarcascade_fullbody.xml'))

cap = cv2.VideoCapture("../Dataset/video/Pedestrian.mp4")
